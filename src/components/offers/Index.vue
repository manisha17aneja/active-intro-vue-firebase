...
<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-breadcrumb">
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">List Offers</h4>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        <div class="uper-add-row">                       
                            ...
                            size="mini"
                            type="success"
                            @click="$router.push({ path: '/offers/create'})"
                            >+ Add</el-button>
                        </div>
    ...
    >
      ...
      <el-table-column label="Short Description" prop="short_description"> </el-table-column>
      ...
      <el-table-column label="Valid until" prop="valid_date"> </el-table-column>
      ...
      <el-table-column align="right">
        ...
        <el-button
            size="mini"
            type="info"
            @click="$router.push({ path: '/offers/edit/'+scope.row.id})"
            >Edit</el-button>
