                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        <div class="uper-add-row">                       
                            ...
                            size="mini"
                            type="success"
                            @click="$router.push({ path: '/subscription_categories/create'})"
                            >+ Add</el-button>
                        </div>
    ...
    >
      ...
      <el-table-column align="right">
        ...
        <el-button
            size="mini"
            type="info"
            @click="$router.push({ path: '/subscription_categories/edit/'+scope.row.id})"
            >Edit</el-button>
...
export default {
  ...
  methods: {
    ...
    readEmployees() {
      this.employeesData = [];
      var i = 1;
      db.collection("categories").where("type", "==", '2')
        .get()
        .then((querySnapshot) => {
